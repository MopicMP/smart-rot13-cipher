...
> Smart rot13 and caesar cipher with n shifts

[![PyPI version](https://badge.fury.io/py/smart-rot13-cipher.svg)](https://pypi.org/project/smart-rot13-cipher/)
...
```bash
pip install smart-rot13-cipher
```
...
from smart_rot13_cipher import batch
